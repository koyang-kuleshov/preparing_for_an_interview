import sys
import os
from PyQt5.QtWidgets import QTableView, QApplication, QWidget, QPushButton,\
    QMainWindow, QAction, QFileDialog
from PyQt5.QtGui import QIcon
from PyQt5.QtSql import QSqlDatabase, QSqlQueryModel, QSqlTableModel,\
    QSqlQuery, QSqlRelationalTableModel, QSqlRelation, QSqlRelationalDelegate
...
class MyWindow(QMainWindow):
    def __init__(self, parent=None):
        ...
        self.db_path = r'dataase/db.sqlite3'
